...
} = require('./node_modules/@-xun/symbiote/dist/packages/project-utils/src/fs.js');

const {
  flattenPackageJsonSubpathMap,
  resolveEntryPointsFromExportsTarget
} = require('./node_modules/@-xun/symbiote/dist/packages/project-utils/src/resolver.js');
...
// ! The aliases described in "alias" are auto-generated by symbiote. Instead of
// ! modifying it directly, consider regenerating aliases across the entire
// ! project: `symbiote project renovate --task regenerate-aliases`; you can
...
module.exports = {
  ...
  env: {
    ...
    test: {
      ...
      sourceMaps: 'inline',
      presets: [
        // {@symbiote/notExtraneous @babel/preset-env}
...
function doCoreJsVersionChecksAndReturnHardcodedVersion() {
  ...
  // ? invariant enforced by symbiote itself
