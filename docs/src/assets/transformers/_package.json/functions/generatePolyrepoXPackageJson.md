...
Defined in: [src/assets/transformers/\_package.json.ts:252](https://github.com/Xunnamius/symbiote/blob/421daaf5e320e2f5d7cb32f23e410fefd48b6891/src/assets/transformers/_package.json.ts#L252)
...
> `readonly` `optional` **publishConfig**: `PublishConfig`
...
> **renovate:aliases**: `` `symbiote project renovate --env NODE_NO_WARNINGS=1 --regenerate-assets --assets-preset ${string} --only-aliases` ``
