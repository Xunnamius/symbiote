...
import { overwriteProperty } from '@-xun/symbiote/assets/eslint.config.mjs';

import {
  isAccessible,
  Tsconfig
} from './node_modules/@-xun/symbiote/dist/packages/project-utils/src/fs.js';
...
import { moduleExport } from '@-xun/symbiote/assets/eslint.config.mjs';*/
...
// ! symbiote. Instead of modifying it directly, consider regenerating aliases
// ! across the entire project: `symbiote project renovate --task
...
if (process.env.SYMBIOTE_LINT_ALLOW_WARNING_COMMENTS !== 'true') {
